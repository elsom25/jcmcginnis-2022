...
The development workflow uses [foreman](https://github.com/ddollar/foreman) to run Bridgetown and
Tailwind CSS in parallel:
...
**Note:** `src/assets/css/style.css` is generated by Tailwind and gitignored. It's built
automatically during `bin/dev` (watch mode) and `bin/build` (production).
